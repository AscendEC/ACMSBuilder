<body>
    ...
    <div id="BodyDiv" class="w-full h-full  bg-gray-700 flex">

            <!--Image panel-->
            <div class="w-full h-full flex justify-center items-center">
                <img class="w-160 h-130" src="./Assets/Images/Banner2.jpg" alt="Banner Image">
            </div>
            ...
            <div class="w-2/3 h-full bg-gray-100 flex items-center justify-center">
                ...
                <div id="SignInForm" class="w-md h-120 rounded-md shadow-md bg-white flex flex-col items-center text-center p-10 ">
                    <h1 class="text-2xl mb-10"><b>ACMSBuilders Inventory Management System</b></h1>
                    <form class="text-start w-full" action="" id="SignInFormElement">
                        ...
                        <input class="rounded-md w-full h-10 my-2 text-white bg-blue-500 hover:bg-blue-700 cursor-pointer" type="submit">
                    </form>
                ...
                <div id="SignUpForm" class="hidden w-md h-120 rounded-md shadow-md bg-white flex flex-col items-center text-center p-10 ">
                    ...
                    <h1 class="text-2xl mb-7"><b>ACMSBuilders</b></h1>
                    <form class="text-start w-full" action="" id="SignUpFormElement">
                        <label class="my-2" for=""><b>Email</b></label> <br>
